...
const SUBCATEGORY_KEYWORDS = {
  ...
  "אוכל": {
    ...
    "מאפיות": ["מאפיה", "מאפיית", "מאפה", "דברי מאפה", "קונדיטוריה", "בייקרי", "bakery", "לחם"],
