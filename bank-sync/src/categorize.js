...
const SUBCATEGORY_KEYWORDS = {
  ...
  'אופנה': {
    'רשתות אופנה': ['גולף', 'golf', 'קסטרו', 'castro', 'פוקס', 'fox', 'רנואר', 'renuar', 'זארה', 'zara', 'h&m', 'אייץ אנד אם', 'מנגו', 'mango', 'ברשקה', 'bershka', 'פול אנד בר', 'pull&bear', 'pull and bear', 'טרמינל', 'terminal x', 'אורבניקה', 'urbanica', 'אמריקן איגל', 'american eagle', 'ריזרבד', 'reserved', 'הודיס', 'hoodies', 'booom', 'טוונטי פור סבן', 'twentyfourseven', 'delta', 'דלתא', 'intima', 'אינטימה'],
