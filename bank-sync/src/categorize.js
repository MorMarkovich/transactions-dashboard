...
const SUBCATEGORY_KEYWORDS = {
  ...
  'מזון וצריכה': {
    ...
    'סופרים': ['שופרסל', 'shufersal', 'רמי לוי', 'rami levy', 'ויקטורי', 'victory', 'יינות ביתן', 'טיב טעם', 'tiv taam', 'אושר עד', 'osher ad', 'חצי חינם', 'יוחננוף', 'yochananof', 'קרפור', 'carrefour', 'מגה בעיר', 'זול ובגדול', 'נתיב החסד', 'ברכל', 'שוק העיר', 'סופרמרקט', 'supermarket', 'מינימרקט', 'מיני מרקט', 'מכולת', 'am:pm', 'אי אם פי אם', 'פרשמרקט', 'freshmarket', 'fresh market'],
