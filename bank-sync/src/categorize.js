...
const SUBCATEGORY_KEYWORDS = {
  ...
  'מזון וצריכה': {
    'פארם וטיפוח': ['סופר פארם', 'סופר-פארם', 'super pharm', 'superpharm', 'super-pharm', 'גוד פארם', 'good pharm', 'ניו פארם'],
    'חנויות סטוק': ['סטוק סנטר', 'booom', 'זול סטוק', 'מקס סטוק', 'max stock', 'זול בשפע', 'כלבו חצי חינם'],
    'סופרים': ['שופרסל', 'shufersal', 'רמי לוי', 'rami levy', 'ויקטורי', 'victory', 'יינות ביתן', 'טיב טעם', 'tiv taam', 'אושר עד', 'osher ad', 'חצי חינם', 'יוחננוף', 'yochananof', 'קרפור', 'carrefour', 'מגה בעיר', 'זול ובגדול', 'נתיב החסד', 'ברכל', 'שוק העיר', 'סופרמרקט', 'supermarket', 'מינימרקט', 'פרימדונה', 'מיני מרקט', 'מכולת', 'am:pm', 'אי אם פי אם', 'פרשמרקט', 'freshmarket', 'fresh market'],
  ...
  'אופנה': {
    'רשתות אופנה': ['גולף', 'golf', 'קסטרו', 'castro', 'פוקס', 'fox', 'רנואר', 'renuar', 'זארה', 'zara', 'h&m', 'אייץ אנד אם', 'מנגו', 'mango', 'ברשקה', 'bershka', 'פול אנד בר', 'pull&bear', 'pull and bear', 'טרמינל', 'terminal x', 'אורבניקה', 'urbanica', 'אמריקן איגל', 'american eagle', 'ריזרבד', 'reserved', 'הודיס', 'hoodies', 'טוונטי פור סבן', 'twentyfourseven', 'delta', 'דלתא', 'intima', 'אינטימה'],
    'נעליים': ['נעלי', 'shoes', 'סקצ', 'skechers', 'nike', 'נייק', 'אדידס', 'adidas', 'new balance', 'ניו באלנס', 'קרוקס', 'crocs', 'טימברלנד', 'timberland', 'סטיב מאדן', 'steve madden', 'אלדו', 'aldo', 'to go', 'טו גו'],
    'קוסמטיקה': ['קוסמטיק', 'cosmetic', 'בשמים', 'perfume', 'פרפיום', 'סבון', 'lush', 'לאש', 'kiko', 'קיקו', 'sephora', 'ספורה', 'yves rocher', 'איב רושה', 'לוריאל', 'loreal', 'מייקאפ', 'makeup', 'לייף סטייל'],
  ...
  'תחבורה ורכבים': {
    ...
    'מוסכים וטיפולים': ['מוסך', 'garage', 'צמיג', 'פנצ', 'גרר', 'מצבר', 'חלפים', 'מכון רישוי', 'בדיקת רכב', 'שטיפת רכב', 'רחיצת', 'car wash', 'מכונאי'],
  },
  'מסעדות, קפה וברים': {
    'משלוחי אוכל': ['wolt', 'וולט', '10bis', 'תנביס', 'משלוחה', 'משלוחים', 'משלוח', 'הזמנת אוכל', 'delivery'],
    'בתי קפה': ['קפה', 'cafe', 'coffee', 'ארומה', 'aroma', 'לנדוור', 'landwer', 'גרג', 'greg', 'אספרסו', 'espresso', 'starbucks', 'סטארבקס', 'קפולסקי', 'רולדין'],
    'מזון מהיר': ['מקדונלד', 'mcdonald', 'בורגר', 'burger', 'kfc', 'פיצה', 'פיצריה', 'pizza', 'דומינו', 'domino', 'שווארמה', 'פלאפל', 'falafel', 'טאקו', 'taco', 'ג\'פניקה', 'japanika', 'סושי', 'sushi'],
  },
  'פנאי, בידור וספורט': {
